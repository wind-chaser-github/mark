...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex selection:bg-indigo-500/30">
      ...
      {/* Sidebar */}
      <aside className="w-72 border-r border-white/20 dark:border-white/5 bg-white/40 dark:bg-black/40 backdrop-blur-2xl p-6 flex-shrink-0 hidden md:block overflow-y-auto h-screen sticky top-0">
        <h2 className="text-xl font-bold tracking-tight mb-8 flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">
